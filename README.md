...
* pygame
* OpenCV-Python
**All in the file `requirements.txt`，you can use pip to install  above of these dependencies**

## How to Run?
```
git clone https://github.com/lewyu/ReinforcementLearningFlyBird.git
cd ReinforcementLearningFlyBird
python deep_q_network.py    
```
You may should use python3 here.And you can use `python train.py` to train this project.
...
3. [DeepLearningFlappyBird](https://github.com/yenchenlin1994/DeepLearningFlappyBird.git)
